...
class Api::V1::UsersControllerTest < ActionController::TestCase
  ...
  test "should create api_v1_user" do
    assert_difference('Api::V1::User.count') do
      post :create, api_v1_user: { email: @api_v1_user.email, firstname: @api_v1_user.firstname, lastname: @api_v1_user.lastname, title: @api_v1_user.title, username: @api_v1_user.username }
    end
  ...
  test "should update api_v1_user" do
    patch :update, id: @api_v1_user, api_v1_user: { email: @api_v1_user.email, firstname: @api_v1_user.firstname, lastname: @api_v1_user.lastname, title: @api_v1_user.title, username: @api_v1_user.username }
    assert_redirected_to api_v1_user_path(assigns(:api_v1_user))
  end
